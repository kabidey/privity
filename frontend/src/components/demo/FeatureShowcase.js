  ...
  const steps = [
    {
      ...
      description: "Your complete Private Equity Management System",
      icon: "🏦",
    },
    {
      title: "Manage Bookings",
      subtitle: "End-to-end workflow",
      description: "Create, track, and manage client investments with automated calculations",
      icon: "📝",
    },
    {
      title: "Track Everything",
      subtitle: "Real-time insights",
      description: "Monitor inventory, revenue, and performance in real-time",
      icon: "📊",
    },
    {
      title: "Ready to Explore?",
      subtitle: "Let's get started",
      description: "Click below to explore PRIVITY features with guided tours",
      icon: "🚀",
    },
  ];
