...
import { Plus, Trash2, Key, UserX, UserCheck, Users, Shield, Link2, Unlink, ChevronRight, Building, LogIn, Eye, Search, Edit, Phone } from 'lucide-react';
                    ...
                    <TableBody>
                      {users
                        ...
                        <TableRow key={user.id} data-testid={`user-row-${user.id}`}>
                          ...
                          <TableCell className="text-sm font-mono">{user.mobile_number || '-'}</TableCell>
