...
async def get_clients(
    ...
    # PE Level and Partners Desk can book for any client they can see
    # Others can only book for clients mapped to them OR created by them
    result = []
    for c in clients:
        client_data = dict(c)
        if is_pe_level(user_role) or is_partners_desk:
            # PE Level and Partners Desk can book for any client they can see
