...
class TestRBACPermissionEnforcement:
    ...
    def test_viewer_can_access_users_list(self):
        """Viewer should be able to access /api/users (has users.view permission)"""
        if not self.viewer_token:
            pytest.skip("Viewer token not available")
        ...
        # Viewer has users.view permission in DEFAULT_ROLES
        assert response.status_code == 200, f"Viewer should access users list: {response.status_code} - {response.text}"
        print(f"✓ Viewer can access users list (status: {response.status_code})")
    ...
    def test_viewer_can_access_finance_payments(self):
        """Viewer should be able to access /api/finance/payments (has finance.view permission)"""
        if not self.viewer_token:
            pytest.skip("Viewer token not available")
        ...
        # Viewer has finance.view permission in DEFAULT_ROLES
        assert response.status_code == 200, f"Viewer should access finance payments: {response.status_code} - {response.text}"
        print(f"✓ Viewer can access finance payments (status: {response.status_code})")
    ...
    def test_viewer_can_access_stocks_view(self):
        """Viewer should be able to access /api/stocks (has stocks.view)"""
        if not self.viewer_token:
            pytest.skip("Viewer token not available")
        ...
        # Viewer should have stocks.view permission
        assert response.status_code == 200, f"Viewer should access stocks view: {response.status_code} - {response.text}"
        print(f"✓ Viewer can access stocks view (status: {response.status_code})")
    ...
    def test_viewer_can_access_purchases(self):
        """Viewer should be able to access /api/purchases (has purchases.view permission)"""
        if not self.viewer_token:
            pytest.skip("Viewer token not available")
        ...
        # Viewer has purchases.view permission in DEFAULT_ROLES
        assert response.status_code == 200, f"Viewer should access purchases: {response.status_code} - {response.text}"
        print(f"✓ Viewer can access purchases (status: {response.status_code})")
...
class TestClientApprovalPermissions:
    ...
    def test_viewer_cannot_approve_client(self):
        """Viewer should not be able to approve clients (requires client_approval.approve)"""
        if not self.viewer_token:
            pytest.skip("Viewer token not available")
        ...
        # Should return 403 Forbidden
        assert response.status_code == 403, f"Viewer should be denied client approval: {response.status_code} - {response.text}"
        print(f"✓ Viewer correctly denied client approval (status: {response.status_code})")
    
    def test_viewer_cannot_delete_client(self):
        """Viewer should not be able to delete clients (requires clients.delete)"""
        if not self.viewer_token:
            pytest.skip("Viewer token not available")
        ...
        # Should return 403 Forbidden
        assert response.status_code == 403, f"Viewer should be denied client delete: {response.status_code} - {response.text}"
        print(f"✓ Viewer correctly denied client delete (status: {response.status_code})")
